...
declare namespace Ammo {
   ...
   export class  btSoftBodyRigidBodyCollisionConfiguration  extends AsmJsObject{}
   ...
   export class btSoftRigidDynamicsWorld {
      ...
      constructor(dispatcher:btCollisionDispatcher, broadphase:btDbvtBroadphase, solver:btSequentialImpulseConstraintSolver,
                  collisionConfiguration:btSoftBodyRigidBodyCollisionConfiguration, softBodySolver:btDefaultSoftBodySolver);
   }
   export class btSoftBodyHelpers {
      CreatePatch(physicsWorld:any, clothCorner00, clothCorner01, clothCorner10, clothCorner11, clothNumSegmentsZ, clothNumSegmentsY , num, flg)

   }
   export function castObject(clothSoftBody, btCollisionObject): any

    export class btHingeConstraint {
       constructor(physicsbody,physicsBody, pivotA, pivotB, _axis, axis, flg)
    }
}
